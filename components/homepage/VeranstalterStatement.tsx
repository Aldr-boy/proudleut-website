...
// sondern eine schmale Bestaetigung (ruhige Einordnung links, Zitat rechts,
// Raster/Gap wie CuratorBlock und FAQ bereits verwenden). "Eine Rückmeldung"
// ist bewusst ein <p>, kein <h2> -- keine eigene Section-Headline, nur eine
// leise redaktionelle Einordnung. Weiterhin KEINE Bewertungs-/Testimonial-
// Card (siehe components/homepage/Testimonials.tsx, dort mehrere Karten mit
// dekorativem Anfuehrungszeichen -- hier nicht wiederverwendet, da das eine
// andere Aussage transportiert).
