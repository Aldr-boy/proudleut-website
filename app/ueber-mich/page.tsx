...
export default async function UeberMichPage() {
  ...
  return (
    <main>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
            <div className="order-2 md:order-1">
              <p className="text-pl-primary text-sm font-medium tracking-wide uppercase mb-4">
                Persönlich hinter proudleut
              </p>
              <h1 className="text-4xl md:text-5xl font-bold text-pl-text mb-6 leading-tight">
                Servus, ich bin Alex.
              </h1>
      ...
      {/* Warum proudleut? */}
      <section className="bg-pl-surface-elevated py-16 md:py-24 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-pl-text mb-8">Warum proudleut?</h2>
          <div className="text-base md:text-lg text-pl-text-muted leading-relaxed space-y-5">
            <p>
              Bei proudleut geht es nicht nur darum, Bands aufzulisten. Es geht darum, Menschen
              miteinander zu verbinden: Veranstalter, die eine passende Band suchen – und
              Musikerinnen und Musiker, die mit ihrer Arbeit sichtbar werden wollen.
            </p>
            <p>
              Ich habe immer wieder erlebt: Gute Bands gibt es viele – aber die passende Band
              für ein Event zu finden, ist oft mühsam. Gleichzeitig ist es für Bands schwer,
              sichtbar zu werden, ohne in einer anonymen Datenbank unterzugehen.
            </p>
            <p>
              Genau da setzt proudleut an: persönlich, übersichtlich und mit direktem Kontakt
              zur Band.
            </p>
          </div>
        </div>
      ...
      {/* Was ich mache */}
      <section className="bg-pl-bg py-16 md:py-20 px-4 sm:px-6">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-pl-text mb-8">Was ich mache</h2>
          <div className="text-base md:text-lg text-pl-text-muted leading-relaxed space-y-5">
            <p>Ich verbinde Bands und Veranstalter – persönlich, nicht anonym.</p>
            <p>
      ...
      <section className="bg-pl-surface py-16 md:py-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            <div>
              <h3 className="text-pl-text font-bold text-lg mb-3">Persönlich</h3>
              <p className="text-pl-text-muted leading-relaxed">
                Ich bin direkt erreichbar und höre erst einmal zu: Was ist geplant, welche
                Stimmung soll entstehen, welche Band könnte wirklich passen?
              </p>
            </div>
            <div>
              <h3 className="text-pl-text font-bold text-lg mb-3">Pragmatisch</h3>
              <p className="text-pl-text-muted leading-relaxed">
                Manchmal muss es schnell gehen. Eine Band fällt aus, ein Termin rückt näher
                oder es fehlt noch die passende Idee. Dann helfe ich unkompliziert weiter.
              </p>
            </div>
            <div>
              <h3 className="text-pl-text font-bold text-lg mb-3">Ehrlich</h3>
              <p className="text-pl-text-muted leading-relaxed">
      ...
      <section className="bg-pl-bg py-16 md:py-20 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-pl-text-muted leading-relaxed mb-10">
              ...
              if (band) {
                return (
                  <Link
                    key={name}
                    href={`/band/${band.slug}`}
                    className="rounded-xl bg-pl-surface px-5 py-4 hover:bg-pl-card-hover motion-safe:transition-colors group"
                  >
                    <p className="text-pl-text font-semibold group-hover:text-pl-primary motion-safe:transition-colors">
                      {name}
                    </p>
                    <p className="text-pl-text-muted text-sm mt-1">{sub}</p>
                  </Link>
                );
              }
              return (
                <div key={name} className="rounded-xl bg-pl-surface px-5 py-4">
                  <p className="text-pl-text font-semibold">{name}</p>
                  <p className="text-pl-text-muted text-sm mt-1">{sub}</p>
                </div>
              );
            })}
